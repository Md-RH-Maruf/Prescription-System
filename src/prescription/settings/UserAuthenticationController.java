...
public class UserAuthenticationController implements Initializable{
	...
	private void loadUserDisplayName() {
		// TODO Auto-generated method stub
		try {
			sql = "select ifnull(displayName,'') as displayname from tblogin where userType != 'Super Admin' order by username ";
			ResultSet rs = databaseHandler.execQuery(sql);
					...
					if(i == list.size()) {
						...
						case "Setup":
							list.addAll(new ModuleItems(1, "Setup", "Supplier Create", true, true, true, false),
								...
								break;
						case "Trading":
							list.addAll(new ModuleItems(6, "Trading", "Purchase", true, true, true, false),
									new ModuleItems(7, "Trading", "Purchase Return", true, true, true, false),
									new ModuleItems(8, "Trading", "Sales", true, true, true, false),
									new ModuleItems(9, "Trading", "Sales Return", true, true, true, false),
									new ModuleItems(10, "Trading", "Servicing", true, true, true, false),
									new ModuleItems(11, "Trading", "Bill Create", true, true, true, false),
